...
class AlgPaperRipple extends AlgComponent {
  ...
  deferredConstructor() {
     ...
     * @type {Boolean}
     */
    if (this.noink == null) this.noink = false; // could be create outside, with a value
    ...
    this.attributeManager
      ...
      .define('noink', TYPE_BOOL)
      .onLink((value, context) => { this.noink = value; })

      .define('recenters', 'boolean');
   ...
   * @type {Boolean}
   */
  get center() { return this.attributeManager.getValue('center'); }
   ...
   * @type {Boolean}
   */
  get recenters() { return this.attributeManager.getValue('recenters'); }
