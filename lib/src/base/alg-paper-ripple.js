...
class AlgPaperRipple extends AlgComponent {
  ...
  deferredConstructor() {
    ...
    this.attributeManager
      ...
      .reflect()
      .store((entry$) => { this.animating$ = entry$; })

      .define('center', TYPE_BOOL, { isPreBinded: true })
      .store((entry$) => { this.center$ = entry$; })
      ...
      .store((entry$) => { this.holdDown$ = entry$; })
      ...
      .store((entry$) => { this.noink$ = entry$; })

      .define('recenters', TYPE_BOOL, { isPreBinded: true })
      .store((entry$) => { this.recenters$ = entry$; });
