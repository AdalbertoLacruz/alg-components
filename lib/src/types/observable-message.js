...
class ObservableMessage extends Observable {
  ...
  constructor(name) {
    ...
    // // Last value received when delayed == true TODO: to remove
    ...
    /**
     * Boolean true, use AttributeManager, same name.
    ...
    /**
     * Boolean true, use EventManager, same name.
   ...
   * @param  {*} value
   * @param  {Object} options -> force, not used
