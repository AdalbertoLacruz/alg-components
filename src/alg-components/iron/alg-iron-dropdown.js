...
import { AlgIronFitBehavior } from '../mixins/alg-iron-fit-behavior.js';
import { AlgIronResizableBehavior } from '../mixins/alg-iron-resizable-behavior.js';
import { AlgIronOverlayBehavior } from '../mixins/alg-iron-overlay-behavior.js';
...
class AlgIronDropdown extends
  mixinFactory(AlgPaperComponent, AlgIronFitBehavior, AlgIronOverlayBehavior, AlgIronResizableBehavior) {
  /**
